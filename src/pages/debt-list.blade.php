...
<div>
  ...
  {{-- 테이블 헤더 --}}
  <div class="grid border-b bg-white" style="grid-template-columns: 60px 1fr 90px 72px">
    <div class="flex items-center justify-center py-[12px] text-[13px] text-gray-md">상담분야</div>
    <div class="flex items-center justify-center py-[12px] text-[13px] text-gray-md">상호</div>
    <div class="flex items-center justify-center py-[12px] text-[13px] text-gray-md">신청일</div>
    <div class="flex items-center justify-center py-[12px] text-[13px] text-gray-md">상세정보</div>
  </div>

  {{-- 데이터 행 --}}
  <div class="grid border-b bg-white" style="grid-template-columns: 60px 1fr 90px 72px">
    <div class="flex items-center justify-center py-[16px] text-[14px] text-black">민사</div>
    <div class="flex items-center justify-center py-[16px] text-[14px] text-black">부실가스</div>
    ...
    <div class="flex items-center justify-center py-[16px]">
      <button class="text-gray-dark" onclick="location.href='debt-detail'">
