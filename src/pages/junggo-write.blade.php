...
<div class="px-[20px] py-[20px] flex flex-col gap-[20px]">
  ...
  <div class="form-field">
    <x-form-label-required label="구분" />
  ...
  {{-- 카테고리 --}}
  <div class="form-field">
    <x-form-label-required label="카테고리" />
    <div class="relative border border-gray-border h-[40px] flex items-center px-[10px] bg-white">
      <select class="form-select">
  ...
  {{-- 거래지역 --}}
  <div class="form-field">
    <x-form-label-required label="지역" />
    <div class="relative border border-gray-border h-[40px] flex items-center px-[10px] bg-white">
      <select class="form-select">
        <option value="">선택</option>
        <option>서울</option>
  ...
  <div class="form-field">
    ...
    <div class="border border-gray-border h-[40px] flex items-center px-[10px] bg-white">
      <input type="tel" placeholder="연락처를 입력해주세요" class="form-input" />
    </div>
  </div>

  {{-- 내용 --}}
  <div class="form-field">
    <x-form-label-required label="내용" />
    <div class="border border-gray-border h-[190px] p-[10px] bg-white">
      <textarea placeholder="내용을 입력해주세요" class="w-full h-full text-[14px] text-black outline-none bg-transparent resize-none placeholder-gray-text"></textarea>
    </div>
  </div>

  {{-- 게시기간 --}}
  <div class="form-field">
    <x-form-label-required label="게시기간" />
    <div class="border border-gray-border h-[40px] flex items-center px-[10px] bg-white">
  ...
  {{-- 파일첨부 --}}
  <div class="form-field">
    <label class="form-label">파일첨부 (5개까지 첨부가능합니다.)</label>
    <div class="flex flex-wrap gap-[10px]">
      {{-- 추가 버튼 --}}
      <label class="w-[80px] h-[80px] bg-gray-light flex items-center justify-center cursor-pointer flex-shrink-0">
      ...
      {{-- 첨부된 사진 예시 1 --}}
      <div class="relative w-[80px] h-[80px] bg-gray-light overflow-hidden flex-shrink-0">
  ...
  <label class="flex items-center gap-[10px] cursor-pointer">
    <input type="checkbox" class="size-[16px] accent-primary" />
    <span class="form-label">개인정보 수집에 동의합니다. <span class="text-red-required">(필수)</span></span>
  </label>
...
<div class="px-[20px] pb-[20px] pt-[4px]">
  <button class="w-full h-[40px] bg-primary text-white text-[14px] font-semibold">
    등록하기
  </button>
</div>
